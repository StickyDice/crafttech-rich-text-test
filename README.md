...
<!-- ----------------------------------------------------------------------- -->
### Изменена логика добавления новых элементов
Теперь для добавления нового элемента необходимо зажать лкм и задать ширину элемента динамически передвижением курсора. Объект будет автоматически добавлен при отпускании лкм.

### Добавлена возможность выбора фигур
Добавленные фигуры:
- Прямоугольник
- Круг
- Эллипс
...
### Изменены иконки для выбора инструментов
